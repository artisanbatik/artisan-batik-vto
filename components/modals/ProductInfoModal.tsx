        ...
        <div className="w-full flex justify-between items-center">
            <div>
                {(productInfoMarkdown || error) && (
                    ...
                    >
                        <WandSparklesIcon className="w-4 h-4" /> Buat Ulang
                    </button>
                )}
            </div>
            <div className="flex items-center gap-3">
                <button 
                    onClick={onClose} 
                    className="px-4 py-2 text-sm font-semibold text-stone-700 dark:text-stone-200 bg-stone-200 dark:bg-stone-700 rounded-md hover:bg-stone-300 dark:hover:bg-stone-600"
                >
                    Tutup
                </button>
                {!isLoading && !error && productInfoMarkdown && (
                    <button 
                        onClick={copyAll} 
                        className="px-5 py-2 font-semibold text-white bg-stone-900 dark:bg-stone-100 dark:text-stone-900 rounded-md hover:bg-stone-700 dark:hover:bg-stone-300"
                    >
