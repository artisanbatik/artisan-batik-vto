...
const DownloadFormatModal: React.FC<DownloadFormatModalProps> = ({ isOpen, onClose, onConfirm, title = "Pilih Format Unduhan", isProcessing = false }) => {
    ...
    const footer = (
        <button
            ...
            className="flex items-center justify-center gap-2 w-full sm:w-auto px-5 py-2 font-semibold text-white bg-stone-900 dark:bg-stone-100 dark:text-stone-900 rounded-md hover:bg-stone-700 dark:hover:bg-stone-300 disabled:opacity-50"
        >
